...
export const CadidateForm = () => (
  <div class="row" className={styles.container}>
    ...
    <div class="row" className={styles.forms}>
      ...
      <div class="col-3" className={styles.nascimento}>
  ...
  <div class="row" className={styles.forms2}>
